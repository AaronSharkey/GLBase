...
public:
     ...
     */
    explicit SimpleMesh(const GLfloat* vertices, const GLuint* indices, size_t elementCount,
     ...
     * @param wireframe Enable wireframe rendering
     */
    explicit SimpleMesh(const GLfloat* vertices, size_t elementCount, int vertexCount, bool wireframe = false);
    ...
    /**
    * @brief Set position + normals attributes (6 floats per vertex).
    */
    void addPositionNormalAttributes();

    /**
    * @brief Set position + normals + tex attributes (8 floats per vertex).
    */
    void addPositionNormalTexAttributes();
...
inline SimpleMesh::SimpleMesh(const GLfloat* const vertices, const size_t elementCount, int vertexCount,
...
inline SimpleMesh::SimpleMesh(const GLfloat* const vertices, const GLuint* indices, const size_t elementCount,
...
inline void SimpleMesh::render() const {
...
inline void SimpleMesh::addVertexAttributes(const GLint index, const GLint size, const GLint stride, const GLint offset,
...
inline void SimpleMesh::addPositionOnlyAttributes() {
    addVertexAttributes(0, 3, 3, 0); // Position: 3 floats, stride 3, offset 0
}

inline void SimpleMesh::addPositionColorAttributes() {
...
inline void SimpleMesh::addPositionTexAttributes() {
...
inline void SimpleMesh::addPositionColorTexAttributes() {
...
inline void SimpleMesh::addPositionNormalAttributes() {
    addVertexAttributes(0, 3, 6, 0); // Position: 3 floats, stride 6, offset 0
    addVertexAttributes(1, 3, 6, 3); // Normal: 3 floats, stride 6, offset 3
}

inline void SimpleMesh::addPositionNormalTexAttributes() {
    addVertexAttributes(0, 3, 8, 0); // Position: 3 floats, stride 8, offset 0
    addVertexAttributes(1, 3, 8, 3); // Normal: 3 floats, stride 8, offset 3
    addVertexAttributes(2, 2, 8, 6); // Tex coords: 2 floats, stride 8, offset 6
}
